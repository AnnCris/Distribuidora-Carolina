...
const AdminDashboard = () => {
  ...
  const stats = {
    ...
    actividadReciente: [
      { id: 1, tipo: 'venta', descripcion: 'Venta #1045', monto: 'Bs. 650.00', fecha: '10:45 AM' },
      { id: 2, tipo: 'cliente', descripcion: 'Nuevo cliente registrado', cliente: 'Juan Pérez', fecha: '09:30 AM' },
      { id: 3, tipo: 'compra', descripcion: 'Compra a proveedor #22', monto: 'Bs. 1,200.00', fecha: 'Ayer, 16:20 PM' },
      { id: 4, tipo: 'venta', descripcion: 'Venta #1044', monto: 'Bs. 425.00', fecha: 'Ayer, 14:15 PM' }
    ]
  };
    ...
    const fetchUserData = async () => {
      try {
        ...
        const response = await axios.get(
          `${process.env.REACT_APP_API_URL || 'http://localhost:8000'}/api/usuarios/usuarios/perfil/`
        );
  ...
  const handleLogout = () => {
    ...
    axios.post(
      `${process.env.REACT_APP_API_URL || 'http://localhost:8000'}/api/usuarios/auth/logout/`
    ).catch(err => {
    ...
    <div className="admin-dashboard">
      <div className={`admin-sidebar ${sidebarCollapsed ? 'collapsed' : ''}`}>
        <div className="admin-sidebar-header">
          <img src={logoCircular} alt="Distribuidora Carolina" className="admin-sidebar-logo" />
        ...
        <div className="admin-user-info">
          ...
          {!sidebarCollapsed && (
            <div className="admin-user-details">
              <p className="admin-user-name">{user?.persona.nombres} {user?.persona.apellido_paterno}</p>
        ...
        {activeModule === 'dashboard' && (
          <div className="admin-dashboard-content">
              ...
              <div className="admin-chart-card">
                ...
                <div className="admin-financial-summary">
                  <div className="admin-financial-item">
                    <h4>Total Ventas</h4>
                    <p className="admin-financial-amount">{stats.totalVentas}</p>
                  </div>
                  <div className="admin-financial-item">
                    <h4>Total Compras</h4>
                    <p className="admin-financial-amount">{stats.totalCompras}</p>
                  </div>
                  <div className="admin-financial-item">
                    <h4>Ganancia</h4>
                    <p className="admin-financial-amount positive">Bs. 25,442.00</p>
                  </div>
                </div>
                <div className="admin-chart-placeholder">
                  ...
                  <div className="admin-placeholder-chart">
                    ...
                    <div className="admin-chart-bar" style={{ height: '65%' }}></div>
                  </div>
                </div>
              </div>
            ...
            <div className="admin-activity-container">
                ...
                {stats.actividadReciente.map(actividad => (
                  <div key={actividad.id} className="admin-activity-item">
                    ...
                    <div className="admin-activity-details">
                      ...
                      {actividad.monto && <p className="admin-activity-amount">{actividad.monto}</p>}
              ...
              <button className="admin-view-all-btn">Ver todas las actividades</button>
            </div>
          </div>
        )}
